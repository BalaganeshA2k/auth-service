...
import com.zano.authenticationservice.security.EncodedEmailPasswordGenerator;
...
public class UserSignInService {
    private final EncodedEmailPasswordGenerator passwordGenerator;
    ...
    public String signInNewUser(UserSignInRequest userSignInRequest) {
        ...
        var password = passwordGenerator.generate(email);
